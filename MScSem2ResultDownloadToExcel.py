...
workbook = openpyxl.load_workbook("A:\MY-PROJECTS\MScPGCollegeSemIIResult.xlsx")
...
for i in range(1,40):
    ...
    i_th_url = url_maker("23","401",college_roll,'2', "REGULAR", "Master of Science in Mathematics")
    # Make a request
    ...
    result=[name,pass_status,sem_percentage]  
    print(result)
...
for row in student_results:
    ws.append(row)
workbook.save("A:\MY-PROJECTS\MScPGCollegeSemIIResult.xlsx")